...
The analysis that we did above is very similar to what has been called the ABBA-BABA test in the population genetic literature (see @Green2010-rv). Specifically, when considering the quadruple of individuals as above, in the order:
